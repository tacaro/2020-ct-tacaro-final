...
In short, termite mounds are **enriched** in the heavy isotope $^{15}N$ due to the action of legumous trees such as *Acacia* and their nitrogen-fixing symbionts. Nitrogen fixation pulls "heavier" nitrogen directly from the atmosphere and averts biological systems that fractionate Nitrogen preferentially towards lighter mass. Thus, there is often a telling isotopic "signature" of Nitrogen fixation.
